...
func TestValidResource(t *testing.T) {
	...
	assert.True(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should be valid")
}
...
func TestInvalidResourceType(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should be invalid, it has invalid resource type")
}
...
func TestLackOfRequiredPropertyInResource(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should not be valid, it does not have required property")
}
func TestLackOfSubpropertyWithSpecification(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should not be valid, it does not have property with specification")
}
...
func TestLackOfPrimitiveTypeInProperty(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource shouldn't be valid")
}
...
func TestLackOfPrimitiveTypeInPropertyNestedInProperty(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource shouldn't be valid, it lacks required property")
}
func TestLackOfRequiredSubproperty(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource shouldn't be valid, required subproperty is missing")
}
func TestLackOfRequiredPrimitiveTypeInNonrequiredSubproperty(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource shouldn't be valid, required primitive property in nonrequired subproperty is missing")
}
...
func TestLackOfRequiredNestedPrimitivePropertyInListItem(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should not be valid, List is empty")
}
...
func TestLackOfRequiredListItemSubpropertyInList(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should not be valid, It must contain RedirectRule property")
}
...
func TestLackOfRequiredPrimitiveTypeListItemInList(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should not be valid, RedirectRule must contain HostName and HttpRedirectCode")
}
...
func TestInvalidList(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource should be valid")
}
...
func TestInvalidNestedNonMapProperty(t *testing.T) {
	...
	assert.False(t, validateResources(resources, &spec, deadProp, deadRes, specInconsistency, &mockContext, false), "This resource shouldn't be valid - Attributes should be a Map")
}
